...
test('test', async ({ page }) => {
    ...
    await expect(page.locator('text=.st0{fill:#303134;} .st1{opacity:0.8;} .st2{fill:#FFFFFF;} با حمایت ما را در ادا')).toBeVisible();
    await expect(page.locator('text=با حمایت ما را در ادامه راه یاری کنید.')).toBeVisible();
    await expect(page.locator('#root >> text=حمایت از پلی پاد')).toBeVisible();
});